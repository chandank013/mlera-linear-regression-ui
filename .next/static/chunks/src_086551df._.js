...
function BuildPage() {
    ...
    const [learningRate, setLearningRate] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(0.05);
    const [iterations, setIterations] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(100);
    const [isModelBuilt, setIsModelBuilt] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState(false);
    const [trainingHistory, setTrainingHistory] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState([]);
    ...
    const [costDomain, setCostDomain] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState([
        0,
        1
    ]);
    ...
    const { xDomain, yDomain } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "BuildPage.useMemo": ()=>{
            const xValues = currentDataset.data.map({
                "BuildPage.useMemo.xValues": (d)=>d[xKey]
            }["BuildPage.useMemo.xValues"]);
            const yValues = currentDataset.data.map({
                "BuildPage.useMemo.yValues": (d)=>d[yKey]
            }["BuildPage.useMemo.yValues"]);
        ...
        "BuildPage.useEffect": ()=>{
            ...
            if (isPlaying && currentStep < iterations - 1) {
                timer = setTimeout({
                    "BuildPage.useEffect": ()=>{
                        setCurrentStep({
                            "BuildPage.useEffect": (prev)=>prev + 1
                        }["BuildPage.useEffect"]);
                    }
                }["BuildPage.useEffect"], 100);
            } else if (currentStep >= iterations - 1) {
                setIsPlaying(false);
            }
            return ({
                "BuildPage.useEffect": ()=>clearTimeout(timer)
            })["BuildPage.useEffect"];
        }
    }["BuildPage.useEffect"], [
        isPlaying,
    ...
    const regressionLine = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "BuildPage.useMemo[regressionLine]": ()=>{
            if (!isModelBuilt || trainingHistory.length === 0) return [];
            const { b0, b1 } = trainingHistory[currentStep];
            const x = currentDataset.data.map({
                "BuildPage.useMemo[regressionLine].x": (d)=>d[xKey]
            }["BuildPage.useMemo[regressionLine].x"]);
            const xMean = x.reduce({
                "BuildPage.useMemo[regressionLine]": (a, b)=>a + b
            }["BuildPage.useMemo[regressionLine]"], 0) / x.length;
            const xStd = Math.sqrt(x.map({
                "BuildPage.useMemo[regressionLine].xStd": (val)=>(val - xMean) ** 2
            }["BuildPage.useMemo[regressionLine].xStd"]).reduce({
                "BuildPage.useMemo[regressionLine].xStd": (a, b)=>a + b
            }["BuildPage.useMemo[regressionLine].xStd"], 0) / x.length);
            const xValues = x;
            const xMin = Math.min(...xValues);
            const xMax = Math.max(...xValues);
    ...
    const costData = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useMemo({
        "BuildPage.useMemo[costData]": ()=>{
            if (!isModelBuilt) return [];
            return trainingHistory.map({
                "BuildPage.useMemo[costData]": (step)=>({
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        ...
                                        !isModelBuilt ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                            ...
                                                            children: isModelBuilt ? "Linear Regression Model (Iteration ".concat(currentStep + 1, ")") : 'Linear Regression Model - Build the model to see the results'
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/build/page.tsx",
                                                            lineNumber: 526,
                                                            columnNumber: 19
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                            className: "text-xl font-bold text-center mb-4",
                                                            children: isModelBuilt ? "Cost vs Iteration (Iteration ".concat(currentStep + 1, ")") : 'Parameter vs Cost - Build the model to see the results'
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/build/page.tsx",
                                                            lineNumber: 552,
                                                            columnNumber: 19
...
_s(BuildPage, "NF0O012irOtetFeYy2rWu1HphrI=");
_c = BuildPage;
var _c;
...
//# sourceMappingURL=src_086551df._.js.map